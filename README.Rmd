...
A flob is a serialized blob of a file, which was read into binary in integer-mode as little endian, that also includes the extension of the original file.
